...
class User extends Authenticatable
{
    ...
    public function relatives(){
        return $this->hasMany('App\Relationship', 'main_user_id', 'id');
    }
    public function relatives2(){
        return $this->hasMany('App\Relationship', 'related_user_id', 'id');
    }
    public function follower(){
        return $this->hasMany('App\Following', 'following_user_id', 'id');
    }
    public function following(){
        return $this->hasMany('App\Following', 'follower_user_id', 'id');
    }
